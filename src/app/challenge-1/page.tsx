        ...
        <>
            <form onSubmit={handleFormSubmit}>
                ...
                <input
                    ...
                    className="block flex-1 border-1 rounded-md bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                ...
                <button
                    type="submit"
                    className="rounded bg-indigo-500 px-8 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 mt-4"
                >
                    Add Two Numbers
                </button>
